...
`TAG=v0.1.16 mise run changelog:write` at release time.

## [0.1.16] - 2026-08-05

### Features

- *(core)* Point a failure at its line and give its remedy a line (#163)
...
- *(core)* Show what the subject did on each case's node (#138)

## [0.1.9] - 2026-08-04

### Features

- *(core)* Let the environment ask for service messages (#136)
