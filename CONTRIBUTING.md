...
```sh
TAG=v0.1.5 mise run changelog:write   # after bumping the version in Cargo.toml
# …commit, PR, merge…
git tag -a v0.1.5 -m "gaveldrop 0.1.5"
git push origin v0.1.5
git tag -f v1 v0.1.5 && git push -f origin v1
```
...
```sh
git show v0.1.5:crates/gaveldrop/src/case.rs | grep "pub stdin"
```
